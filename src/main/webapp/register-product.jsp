...
<title>Bumble Bee- Register Product</title>
</head>
<body>
	...
	<div class="container">
		...
		<form method="post" action="product" >
			<div class="mb-3">
				  ...
				  <input type="text" class="form-control" id="exampleFormControlInput1" name="productname" placeholder="Huawei">
				</div>
				<div class="mb-3">
				  <label for="exampleFormControlTextarea1" class="form-label">Product Price</label>
				  <input type="number" class="form-control" id="exampleFormControlInput1" name="productprice" placeholder="Price in LKR">
