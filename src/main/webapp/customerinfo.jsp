...
<title>Bumble Bee - Customer Information</title>
</head>
<body>
<div class="container">
	...
	<table class="table table-success  table-striped-columns">
		  ...
		  <tbody>
		  <tag:forEach var="customerinfo" items="${customerinfoList}"> 
			   <tr>
			      <td>${customerinfo.customerCode}</td>
			      <td>${customerinfo.customerFullname}</td>
			      <td>${customerinfo.customerDOB}</td>
			      <td>${customerinfo.customerLoanBalance}</td>
			      <td>${customerinfo.customerUsedAmount}</td>
			      <td>${customerinfo.customerInstallmentPlan}</td>
