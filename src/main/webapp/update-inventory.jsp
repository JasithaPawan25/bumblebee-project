...
<title>BumbleBee-Inventory</title>
</head>
<body>
	<div class="container">
	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary mt-2">
		...
		<h3>Search Inventory</h3>
			...
			<div class="mb-3">
				  <label for="exampleFormControlInput1" class="form-label">Inventory Code</label>
				  <input type="number" class="form-control" id="exampleFormControlInput1" name="inventoryCode" placeholder="Enter code...">
				</div>			
					<input type="hidden" name="type" value="specific">
				<button type="submit" class="btn btn-success">Search Inventory</button>	
			</div>
		</form>
		<br/>
		<div class="container">
