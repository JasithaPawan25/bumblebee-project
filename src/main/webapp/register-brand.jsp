...
<title>Bumble Bee- Register Brand</title>
</head>
<body>
<div class="container">
<nav class="navbar navbar-expand-lg bg-body-tertiary mt-2">
		...
		<hr/>
			...
			<div class="mb-3">
				  ...
				  <input type="text" class="form-control" id="exampleFormControlInput1" name="brandName" placeholder="^Y model">
				</div>
				<div class="mb-3">
				  <label for="exampleFormControlTextarea2" class="form-label">Brand Year</label>
				  <input type="text" class="form-control" id="exampleFormControlInput2" name="brandYear" placeholder="Good to...">
					<input type="hidden" name="type" value="add">
				</div>
				<button type="submit" class="btn btn-success">Register Brand</button>	
			</div>
		</form>
</div>
</body>
